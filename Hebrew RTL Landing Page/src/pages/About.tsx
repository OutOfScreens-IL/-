          ...
          <div className="about-profiles-grid" style={{
            ...
            <div className="profile-card" style={{
              ...
              <div style={{ padding: "28px 28px 32px" }}>
                ...
                <p style={{ fontSize: 15, lineHeight: 1.75, color: "rgba(12,12,12,0.68)", margin: "0 0 24px" }}>
                  בעלת תואר ראשון בניהול, עם ניסיון בהדרכה ועבודה עם ילדים ובני נוער. שירתה כמדריכת כושר בסיירת חרוב. בנוסף עבדה כסייעת בחטיבת ביניים וליוותה תלמידים בסביבה חינוכית וחברתית.
                </p>
